  ...
  .factory('isyTranslateFactory', function () {
    ...
    var translateOptions = {
      ...
      nn: {
        ...
        add_layer_start_drawing: "Klikk for å starte teikning",
        add_layer_continue_drawing: "Klikk for å fortsetje å teikne.",
        add_layer_modify_object: "Vel objekt og start redigering.",
        start_drawing: "Klikk for å starte teikning",
        continue_drawing: "Klikk for å fortsetje å teikne polygon. Klikk i siste punktet for å avslutte polygon.",
        start_measure: "Klikk for å starte teikning",
        continue_measure: "Klikk for å fortsetje å teikne polygon. Klikk i siste punktet for å avslutte polygon.",
        start_measure_line: "Klikk for å starte teikning",
        continue_measure_line: "Klikk for å fortsetje å teikne linja. Klikk i siste punktet for å avslutte linja."
      },
      en: {
        east: "E ",
        north: "N ",
